...
const AiContact = () => {
  ...
  return (
    <div className="ai-contact-container">
      <h2>Fill The Form for AI Services</h2>
      <form onSubmit={handleSubmit}>
        <div className="form-group">
          ...
          >
            ...
            <option value="mlDevelopment">Machine Learning Model Development</option>
            ...
            <option value="chatbots">AI-Powered Chatbots and Virtual Assistants</option>
          </select>
        </div>
