...
def custom_responses(question):
    ...
    "headquarter": "Address: 52/210, Padmani VT Rd, Ward 27, Mansarovar Sector 5, Mansarovar, Jaipur, Rajasthan 302020 🏢",
    "located situated location address headquarters": "Address: 52/210, Padmani VT Rd, Ward 27, Mansarovar Sector 5, Mansarovar, Jaipur, Rajasthan 302020 🏢",
}
    ...
    response = {
        ...
        "App Development Services": "App Development: Transforming ideas into powerful mobile solutions. Custom app development tailored to your business needs. Expert team delivering seamless iOS and Android experiences 📱💡\n",
        ...
        "About ceo owner founder Tanishq Sharma": "Tanishq Sharma is a tech entrepreneur and the founder of ANTI AI, a company dedicated to safeguarding the world from the potential dangers of AGI 🧑‍💼🚀.\n",
        "service services provided by anti ai": "OUR SERVICES\nAI 🤖\t\t\t\t\tWeb 🌐\nDevOps 🛠️\t\t\t\tCloud ☁️\nApp Development 📱",
